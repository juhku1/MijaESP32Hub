...
"padding:22px 24px;background:linear-gradient(135deg,#152341 0%,#1c2b52 100%);"
"border-radius:18px;border:1px solid #223150;box-shadow:var(--shadow)}"
"h1{color:var(--text);font-size:28px;margin:0;font-weight:700;letter-spacing:-0.4px;"
"display:flex;align-items:center;gap:12px}"
"h1::before{content:'📡';font-size:30px}"
...
"margin-bottom:12px;box-shadow:var(--shadow);position:relative;transition:all 0.2s;z-index:1}"
...
".device-card.unsaved .device-name::after{content:' (ei tallennettu)';font-size:12px;color:var(--accent-2);font-weight:500}"
".device-header{display:flex;justify-content:space-between;align-items:flex-start;gap:16px}"
".device-info{flex:1}"
".device-name{font-size:18px;font-weight:700;color:var(--text);margin-bottom:6px;letter-spacing:-0.2px}"
...
"html+=' <div style=\"font-size:12px;color:#94a3b8;margin-top:2px;display:flex;gap:8px;flex-wrap:wrap;\">Lähde: '+sourceLabel;"
"if(d.fieldMask&32){const age=(typeof d.ageSec==='number')?d.ageSec:0;html+=' • Päivitys: '+age+'s';}"
"html+='</div>';"
"html+=' </div>'"
...
"const fields=[{bit:1,label:'Lämpötila'},{bit:2,label:'Kosteus'},{bit:4,label:'Akku %'},{bit:8,label:'Jännite'},{bit:16,label:'Signaali'},{bit:32,label:'Päivitys (s)'}];"
"fields.forEach(f=>{"
