...
"<div><a href='https://github.com/juhku1/MijaESP32Hub' target='_blank'>github.com/juhku1/MijaESP32Hub</a></div>"
"</div>"
"</div>"
...
"if(!r.ok){console.error('Failed to load cloud settings:',r.status);return;}"
...
"catch(e){console.error('Error loading cloud settings:',e);}}else if(tab==='scan'){"
...
"<button class='settings-tab-btn active' data-tab='cloud' onclick='switchSettingsTab(\"cloud\")'>☁️ Cloud</button>"
...
"<input type='text' id='aioUser' placeholder='e.g. juhku' style='width:100%;padding:10px;border:1px solid #334155;border-radius:8px;background:#1e293b;color:#e2e8f0;'></div>"
...
"<li>Max <strong>10 feeds</strong> per user</li>"
"<li>Max <strong>30 messages per minute</strong></li>"
"<li>Choose data types as needed (temp/humidity/battery)</li>"
"</ul>"
"</div>"
