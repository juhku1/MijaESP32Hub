...
"<button class='toggle-btn' id='scanBtn' onclick='openDiscovery()'>🔍 Löydä laitteita</button>"
"<button class='toggle-btn' onclick='openAioSettings()'>☁️ Pilvi</button>"
"</div>"
"</div>"
"<div id='devices'></div>"
"</div>"
...
"btn.textContent='⏳ Skannaa ('+scanCountdown+'s)';"
"scanInterval=setInterval(()=>{"
"scanCountdown--;"
"if(scanCountdown<=0){"
"clearInterval(scanInterval);"
"btn.textContent='🔍 Löydä laitteita';"
"btn.disabled=false;"
"}else{"
"btn.textContent='⏳ Skannaa ('+scanCountdown+'s)';}"
"},1000);"
"}else{"
"alert('Skannauksen käynnistys epäonnistui: '+result.error);"
"btn.textContent='🔍 Löydä laitteita';"
"btn.disabled=false;}"
"}catch(err){"
...
"if(openSettings){console.log('Asetukset auki, ohitetaan päivitys');return;}"
"try{"
...
"+' <div class=\"device-name\">'+name;"
"if(d.source&&d.source.startsWith('satellite-')){"
...
"const d=await r.json();if(d.ok){alert('Asetukset tallennettu!');closeAioSettings();window.oldFeedTypes=feedTypes;}else{alert('Virhe: '+d.error);}}"
...
"</script>"
"<div id='aioModal' class='modal'><div class='modal-content' style='max-width:600px;'>"
"<div class='modal-header'><h2>☁️ Adafruit IO</h2>"
"<button class='modal-close' onclick='closeAioSettings()'>×</button></div>"
...
"</div>"
"<button onclick='saveAioSettings()' style='width:100%;padding:12px;background:#10b981;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;margin-bottom:10px;'>💾 Tallenna ja sulje</button>"
