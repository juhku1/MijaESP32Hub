...
"body:JSON.stringify({username:user,key:key,enabled:enabled})});"
"const d=await r.json();if(d.ok){alert('Asetukset tallennettu!');closeAioSettings();}else{alert('Virhe: '+d.error);}}"
...
"<input type='text' id='aioUser' style='width:100%;padding:10px;border:1px solid #334155;border-radius:8px;background:#1e293b;color:#e2e8f0;'></div>"
"<div style='margin-bottom:15px;'><label style='display:block;margin-bottom:5px;font-weight:600;'>AIO Key:</label>"
"<input type='password' id='aioKey' style='width:100%;padding:10px;border:1px solid #334155;border-radius:8px;background:#1e293b;color:#e2e8f0;'></div>"
...
"<button onclick='sendAioNow()' style='width:100%;padding:12px;background:#3b82f6;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;'>📤 Lähetä nyt (testi)</button>"
"</div></div></div>"
"</body>"
"</html>";
