...
".device-card.hidden{opacity:0.5;background:#172033;border:1px dashed #334155}"
".device-card.hidden .device-name{color:#64748b}"
...
"<button class='toggle-btn' id='scanBtn' onclick='startScan()'>🔍 Skannaa uusia</button>"
